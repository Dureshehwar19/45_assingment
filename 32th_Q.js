...
//current user's list
let current_users = ['jimmy', 'haroon', 'rawish', 'hina', 'meesam', 'ishfa'];
// new user's list
let new_users = ['maria', 'jimmy', 'pareeshy', 'ishfa', 'deran'];
// Function to check if a username is available
function UsernameAvailable(username) {
    // Convert both username arrays to lowercase for comparison
    let current_usersLowercase = current_users.map(user => user.toLowerCase());
